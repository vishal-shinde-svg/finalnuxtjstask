...
<div class="flex items-center justify-center min-h-screen  bg-red-500">
    <div class="px-8 py-6 mt-4 text-left bg-white shadow-lg border rounded-2xl">
        <p class="text-2xl font-bold m-5 ">
            Login
        </p>

        <div>
            <input v-model="name" aria-label="Enter your email address" type="name" placeholder="User Name" class="text-sm text-gray-base w-full
                                mr-3 py-5 px-4 h-2 border
                                border-gray-200 rounded mb-2 bg-gray-600" />
            <input v-model="password" aria-label="Enter your password" type="password" placeholder="Password" class="text-sm text-gray-base w-full mr-3
